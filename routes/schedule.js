...
router.post('/create', async (req, res) => {
    try {
        ...
        const { accessToken, topic, useUntil, startUse, time1, class1, time2, class2, time3, class3, time4, class4, time5, class5, time6, class6, time7, class7, time8, class8, time9, class9 } = req.body;
